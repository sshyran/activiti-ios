...
@implementation ASDKModelFormFieldFileSource
...
+ (NSValueTransformer *)selectedFolderJSONTransformer {
    return [MTLJSONAdapter dictionaryTransformerWithModelClass:ASDKModelFileSourceFolder.class];
}
