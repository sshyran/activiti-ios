...
#import "ASDKModelFileSourceFolder.h"
#import "ASDKModelFileSourceFolderTreeElement.h"

#if ! __has_feature(objc_arc)
#warning This file must be compiled with ARC. Use -fobjc-arc flag (or convert project to ARC).
#endif

@implementation ASDKModelFileSourceFolder
...
+ (NSValueTransformer *)folderTreeJSONTransformer {
    return [MTLJSONAdapter arrayTransformerWithModelClass:ASDKModelFileSourceFolderTreeElement.class];
}
