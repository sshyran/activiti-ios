...
@implementation ASDKModelProcessInstanceContent
...
+ (NSValueTransformer *)fieldJSONTransformer {
    return [MTLJSONAdapter dictionaryTransformerWithModelClass:ASDKModelProcessInstanceContentField.class];
}
