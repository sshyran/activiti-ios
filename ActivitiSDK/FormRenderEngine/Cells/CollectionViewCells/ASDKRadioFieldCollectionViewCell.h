...
@interface ASDKRadioFieldCollectionViewCell : ASDKFormThemedCollectionViewCell <ASDKFormCellProtocol>
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *trailingToDisclosureConstraint;
