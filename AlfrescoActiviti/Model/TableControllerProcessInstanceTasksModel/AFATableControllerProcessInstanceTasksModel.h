...
typedef NS_ENUM(NSInteger, AFATableControllerProcessInstanceTasksSectionType) {
    AFATableControllerProcessInstanceTasksSectionTypeActive = 0,
    AFATableControllerProcessInstanceTasksSectionTypeCompleted,
