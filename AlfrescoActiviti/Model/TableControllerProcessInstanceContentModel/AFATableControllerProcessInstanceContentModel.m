...
@implementation AFATableControllerProcessInstanceContentModel

#pragma mark -
#pragma mark AFATableViewModel Delegate

- (NSInteger)numberOfSections {
    return self.attachedContentArr.count;
}

- (NSString *)titleForHeaderInSection:(NSInteger)section {
    return ((ASDKModelProcessInstanceContent *)self.attachedContentArr[section]).field.name;
}
...
- (BOOL)hasContentAvailable {
    return self.attachedContentArr.count ? YES : NO;
}
