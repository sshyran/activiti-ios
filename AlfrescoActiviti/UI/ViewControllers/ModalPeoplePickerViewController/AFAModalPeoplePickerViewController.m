...
@interface AFAModalPeoplePickerViewController ()
...
@implementation AFAModalPeoplePickerViewController
...
- (void)viewDidLoad {
    ...
    self.emailAddressLabel.text = NSLocalizedString(kLocalizationProfileScreenEmailText, @"Email label");
    ...
    [self.confirmButton setTitle:NSLocalizedString(kLocalizationPeoplePickerControllerInviteText, @"Invite button")
                        forState:UIControlStateNormal];
    [self validateEmailAddressFieldForString:self.emailAddressTextField.text];
...
- (IBAction)onConfirm:(id)sender {
    ...
    ASDKModelUser *user = [ASDKModelUser new];
...
- (IBAction)onEmailAddressTextFieldChange:(UITextField *)sender {
    [self validateEmailAddressFieldForString:sender.text];
}
...
- (void)validateEmailAddressFieldForString:(NSString *)emailAddress {
    BOOL enableCreateButton = [[emailAddress normalizedEmailAddress] isValidEmailAddress];
