...
@interface AFAClaimTableViewCell : UITableViewCell

@property (weak, nonatomic) id<AFAClaimTableViewCellDelegate> delegate;
@property (weak, nonatomic) IBOutlet ASDKRoundedBorderView    *claimRoundedBorderView;
