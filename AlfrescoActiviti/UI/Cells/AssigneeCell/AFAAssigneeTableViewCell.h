...
@protocol AFAAssigneeTableViewCellDelegate <NSObject>

- (void)onChangeAssignee;

@end

@interface AFAAssigneeTableViewCell : UITableViewCell

@property (weak, nonatomic) id<AFAAssigneeTableViewCellDelegate> delegate;
