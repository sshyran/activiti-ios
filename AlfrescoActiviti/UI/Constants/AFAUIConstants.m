...
NSString *kCellIDTaskDetailsTask                                = @"TaskDetailsTaskCellID";
...
NSString *kSegueIDTaskDetailsViewTask                           = @"TaskDetailsViewTaskSegueID";
NSString *kSegueIDTaskDetailsViewTaskUnwind                     = @"TaskDetailsViewTaskUnwindSegueID";
