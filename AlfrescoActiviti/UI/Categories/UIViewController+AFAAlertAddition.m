...
@implementation UIViewController (AFAAlertAddition)

- (void)showGenericNetworkErrorAlertControllerWithMessage:(NSString *)networkErrorMessage {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(kLocalizationAlertDialogOopsTitleText, @"Oops title")
...
- (void)showConfirmationAlertControllerWithMessage:(NSString *)confirmationMessage
                           confirmationBlockAction:(AFAAlertAdditionConfirmationBlock)confirmationBlock {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:nil
                                                                             message:confirmationMessage
                                                                      preferredStyle:UIAlertControllerStyleAlert];

    UIAlertAction *yesButtonAction = [UIAlertAction actionWithTitle:NSLocalizedString(kLocalizationAlertDialogConfirmText, @"YES text")
    ...
    UIAlertAction *cancelButtonAction = [UIAlertAction actionWithTitle:NSLocalizedString(kLocalizationAlertDialogCancelButtonText, @"Cancel text")
